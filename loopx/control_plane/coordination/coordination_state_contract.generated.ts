...
export const COORDINATION_STATE_CONTRACT = deepFreeze({
  ...
  "replan_settlement_protocol": {
    "request_schema": "loopx_replan_settlement_request_v0",
...
export const REPLAN_SETTLEMENT_REQUEST_SCHEMA = COORDINATION_STATE_CONTRACT.replan_settlement_protocol.request_schema;
export const REPLAN_SETTLEMENT_RESULT_SCHEMA = COORDINATION_STATE_CONTRACT.replan_settlement_protocol.result_schema;
export const REPLAN_SETTLEMENT_LIFECYCLE_REENTRY_REQUEST_SCHEMA = COORDINATION_STATE_CONTRACT.replan_settlement_protocol.lifecycle_reentry_request_schema;
export const REPLAN_SETTLEMENT_LIFECYCLE_REENTRY_RESULT_SCHEMA = COORDINATION_STATE_CONTRACT.replan_settlement_protocol.lifecycle_reentry_result_schema;
